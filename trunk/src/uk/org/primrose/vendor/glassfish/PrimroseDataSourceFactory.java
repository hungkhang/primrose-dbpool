...
// C:\java\glassfish\bin>asadmin create-custom-resource --restype 
// javax.naming.spi.ObjectFactory --factoryclass 
// uk.org.primrose.vendor.glassfish.PrimroseDataSourceFactory --property 
// poolName=hcr:primroseConfigFile=/java/primrose_3.0/dummy.conf jdbc/hcr 
public class PrimroseDataSourceFactory extends GenericDataSourceFactory 
    ...
    public Object getObjectInstance(Object refObj, Name nm, Context ctx, 
        ...
        // Glassfish seems to call the factory each time you 
        // look up the JNDI name ... so don't load the pool twice ! 
