...
public class ObjectRefAddr extends javax.naming.BinaryRefAddr { 
    /** 
     * 
     */ 
    ...
    public ObjectRefAddr(String addrType, byte[] src) { 
        super(addrType, src); 
    } 
 
    public ObjectRefAddr(String addrType, byte[] src, int offset, int count) { 
        super(addrType, src, offset, count); 
    } 
